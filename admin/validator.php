                ...
                <div class="col-sm-10 border border-dark">
                    <div class="container">
                        ...
                        <div class='row text-center'>
                            ...
                            <h3 class='text-center my-4'>Validator Accounts</h3>

                            <?php

                            include "include/connect.php";

                            $sql = "select*from validator";
                            ...
                            while ($row =  mysqli_fetch_assoc($result)) {
                                ...
                                $output = $output . "<tr class='text-center'>
                                                            ...
                                                            <td>{$row['v_email']}</td>
                                                            <td>
                                                              <a href='view.php?id={$row['v_id']}' class= 'btn-sm btn-danger'>View</a>
                                                              <a href ='edit-validator.php?id={$row['v_id']}' class='btn-sm btn-success'>Edit</a>
                                                              <a href ='delete.php?id={$row['v_id']}' class= 'btn-sm btn-dark'>Delete</a>
                                                              </td>
                                                       </tr>";
                            }
